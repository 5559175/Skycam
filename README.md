...
The server runs 24/7 and to save cost has a very low power (17W TDP) Intel Xeon E3-1220L v2 (2C/4T), 16GB RAM and Nvidia Quadro P600 GPU which is used for acceleration of encode/decode with ffpmeg, and for the portions of MetDetPy which can be accelerated with CUDA.
...
The requirements.txt is included in the "MetDetPy_customisations" folder along with a script I call to run it to make use of my Quadro P600.
